...
<head>
    ...
    <title>Assignment || Invoice Item Reports</title>
...
<body>
<div class="m-lg-4"><a href="../" class="crad-link text-secondary">All Reports</a> / Invoice Item Reports</div>
...
<div class="container w-100">
    <div class="row">
        ...
        <div class="col-lg-8">
            <button onclick="ExportToExcel('Invoice_Items','xlsx')" class="btn btn-secondary pull-right"><i
    ...
    <div class="table-screen">
        <table class="table table-hover table-bordered mt-3" id="report_table">
            ...
            if (isset($_GET['daterange'])) {
                ...
                $sql1 = "SELECT invoice.*,invoice_master.*,customer.title,customer.first_name,customer.last_name,item.item_category,item.item_code,item.item_name,item_category.category FROM invoice_master
            ...
            while ($data = $select1->fetch()) {
                ...
                <tr>
                    ...
                    <td><?php echo $data['item_name'] . " (" . $data['item_code'] . ")"; ?></td>
